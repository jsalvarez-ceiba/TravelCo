        ...
        <div data-aos="flip-left">
          ...
          <div className="card text-dark bg-warning mb-3 " >
            ...
            <div className="card-body">
              ...
              <p className="card-text">Con nosotros tendras los viajes mas placenteros de tu vida</p>
            </div>
          </div>
        ...
        <div data-aos="flip-left">
          ...
          <div className="card text-white bg-primary mb-3" >
            ...
            <div className="card-body">
              ...
              <p className="card-text">En travelco garantizamos tu tranquilidad durante tus viajes</p>
            </div>
          </div>
        ...
        <div data-aos="flip-left">
          ...
          <div className="card text-white bg-danger mb-3" >
            ...
            <div className="card-body">
              ...
              <p className="card-text">Nos preocupamos por protegerte a ti y a tus seres queridos</p>
            </div>
          </div>
